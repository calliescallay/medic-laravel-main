        ...
        <div class="row">
            <div class="col-12">
                ...
                <?php if(Auth::user()->role == 'admin'): ?>
                    <a href="<?php echo e(route('perawat.create')); ?>" class="btn btn-primary mt-3">Tambah Data</a>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\medic-laravel-main\resources\views/perawat/index.blade.php ENDPATH**/ ?>